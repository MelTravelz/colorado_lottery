...
RSpec.describe ColoradoLottery do
  ...
  describe "#charge_contestants" do
    ...
    it "charges the contestant & adds to current_contestants hash" do
      lottery.charge_contestants(cash_5)

      expected_hash = { cash_5 => [winston.full_name, grace.full_name] }
      ...
      # This would be an expected_hash again and one more expect statement...
      # end of Iteration 3
    end
  end
